...
IOPinMapTypeDef IOMap =
{
	...
	.ID_CLK =  // IOPinTypeDef ID_CLK
	{
		...
		.resetConfiguration  =
		{
			...
			.GPIO_OType  = GPIO_MODE_OUT_PP,        // GPIOSpeed_TypeDef GPIO_Speed
			.GPIO_Speed  = GPIO_OSPEED_50MHZ,     // GPIOOType_TypeDef GPIO_OType
			.GPIO_PuPd   = GPIO_MODE_OUT_PP      // GPIOPuPd_TypeDef GPIO_PuPd
		}
	},
	...
	.ID_CH0 =  // IOPinTypeDef ID_CH0
	{
		...
		.resetConfiguration  =
		{
			...
			.GPIO_OType  = GPIO_MODE_IN_FLOATING,        // GPIOSpeed_TypeDef GPIO_Speed
			.GPIO_Speed  = GPIO_OSPEED_50MHZ,     // GPIOOType_TypeDef GPIO_OType
			.GPIO_PuPd   = GPIO_MODE_IN_FLOATING      // GPIOPuPd_TypeDef GPIO_PuPd
		}
	},
	// FLASH CSN PC0( PC0 PC7 shorted on board)
	...
	.DIO10_PWM_WL =  // IOPinTypeDef DIO10_PWM_WL
	{
		...
		.resetConfiguration  =
		{
			...
			.GPIO_OType  = GPIO_MODE_AF_PP,        // GPIOSpeed_TypeDef GPIO_Speed
			.GPIO_Speed  = GPIO_OSPEED_50MHZ,     // GPIOOType_TypeDef GPIO_OType
			.GPIO_PuPd   = GPIO_MODE_AF_PP      // GPIOPuPd_TypeDef GPIO_PuPd
		}
	},
	// TODO PA0 no usart3 tx
	...
	.USB_V_BUS =  // IOPinTypeDef USB_V_BUS
	{
		...
		.resetConfiguration  =
		{
			...
			.GPIO_OType  = GPIO_MODE_AIN,        // GPIOSpeed_TypeDef GPIO_Speed
			.GPIO_Speed  = GPIO_OSPEED_MAX,    // GPIOOType_TypeDef GPIO_OType
			.GPIO_PuPd   = GPIO_MODE_AIN      // GPIOPuPd_TypeDef GPIO_PuPd
		}
	},
	...
	.BUTTON =  // IOPinTypeDef BUTTON
	{
		...
		.resetConfiguration  =
		{
				...
				.GPIO_OType  = GPIO_MODE_IPU,    	// GPIOSpeed_TypeDef GPIO_Speed
				.GPIO_Speed  = GPIO_OSPEED_50MHZ,     // GPIOOType_TypeDef GPIO_OType
				.GPIO_PuPd   = GPIO_MODE_IPU      // GPIOPuPd_TypeDef GPIO_PuPd - There is an external pull-down connected.
		}
	},
